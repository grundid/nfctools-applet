...
public class UriRecordBuilder implements Builder {

	@Override
	public boolean canHandle(String type) {
		return "uriRecord".equals(type);
	}

	@Override
	public Record convert(Map<String, String> data) {
		return new UriRecord(data.get("uri"));
	}
	...
	public Map<String, String> convert(Record record) {
		return MapBuilder.map("type", "uriRecord", "uri", ((UriRecord)record).getUri());
	}
